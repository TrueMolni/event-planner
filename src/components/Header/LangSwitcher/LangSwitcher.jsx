...
const LangSwitcher = () => {
  ...
  return (
    <div className="relative mm:absolute mm:right-[22px] ml-[22px] inline-block text-left pointer-events-none">
      <select
      ...
      <svg
        className="fill-current h-4 w-4 absolute absolute top-4 right-2"
